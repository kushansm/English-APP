                ...
                <div className="bg-white/5 border border-white/10 p-10 rounded-[40px] backdrop-blur-2xl shadow-2xl space-y-10">
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <div className="space-y-1">
                            <h1 className="text-xl font-black tracking-tight italic">Initialize <span className="text-indigo-400">Account</span></h1>
                            <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em]">Start your academic trajectory</p>
                        </div>
                    </div>

                    {/* Features Tagline */}
                    <div className="flex justify-center gap-2">
                        {['AI-Driven', 'CEFR Aligned', 'Adaptive'].map((tag) => (
                            <span key={tag} className="text-[8px] font-black text-gray-500 border border-white/5 bg-white/5 px-2 py-1 rounded-full uppercase tracking-widest">{tag}</span>
                        ))}
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label className="text-[9px] font-black text-gray-500 uppercase tracking-widest px-1">Email Address</label>
                                <input
                                    type="email"
                                    value={email}
                            ...
                            <div className="space-y-2">
                                <label className="text-[9px] font-black text-gray-500 uppercase tracking-widest px-1">Security Key (min. 8)</label>
                                <input
                                    type="password"
                                    value={password}
                    ...
                    <div className="pt-4 text-center">
                        <Link href="/login" className="text-[10px] font-black text-gray-500 hover:text-white uppercase tracking-[0.2em] transition-colors">
                            Already have an account? <span className="text-indigo-400 ml-1">Sign In</span>
                        </Link>
                    </div>
                </div>

                <p className="mt-12 text-center text-[10px] font-black text-gray-700 uppercase tracking-[0.4em]">
                    Academic Framework v2.1 • Enrollment Active
                </p>
            </div>
        </div>
    );
